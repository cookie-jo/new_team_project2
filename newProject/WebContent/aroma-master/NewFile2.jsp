...
<div class="rb-box" id="searchType" name="searchType" data-value="${searchType }">
...
<!--    // <button class="button trigger" type = "submit">SUBMIT</button> -->
				...
				<button class="button trigger" type = "submit" onclick="myClick()">SUBMIT</button>

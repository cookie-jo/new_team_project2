				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						<div class="product_count">
							...
							<!--jsp 이미지 상품명 가격 수량 숫자까지  cart.jsp로 넘기는 부분--> 
					...
					<div class="row">
						...
						<div class="col-lg-6">
							<div class="review_box">
								...
								<!-- 리뷰등록 -->
								<p>Outstanding</p>
								<form action="../review" class="form-contact form-review mt-3">
									<div class="form-group">
										<textarea class="form-control different-control w-100"
											name="review_score" id="textarea" cols="30" rows="5"
											placeholder="평점자리"></textarea>
									</div>
									<div class="form-group">
										<textarea class="form-control different-control w-100"
											name="review_main" id="textarea" cols="30" rows="5"
